...
dict_of_hist = {(1,1,2):theta_diff_112,(1,1,3):theta_diff_112,(1,2,2):theta_diff_122,(1,3,2):theta_diff_132,(1,4,2):theta_diff_142,(2,1,2):theta_diff_212,(2,1,3):theta_diff_213,(2,2,2):theta_diff_222,(2,3,2):theta_diff_232,(2,4,2):theta_diff_242,(2,2,1):theta_diff_221,(1,2,1):theta_diff_121,(1,3,1):theta_diff_131,(1,4,1):theta_diff_141,(2,4,1):theta_diff_241,(2,3,1):theta_diff_231}
#theta_vs_theta_112 = ROOT.TH2D("theta_vs_theta_112","theta_vs_theta_112",80,-1,1,80,-1,1)
#theta_vs_theta_113 = ROOT.TH2D("theta_vs_theta_113","theta_vs_theta_113",80,-1,1,80,-1,1)
#theta_vs_theta_122 = ROOT.TH2D("theta_vs_theta_122","theta_vs_theta_122",80,-1,1,80,-1,1)
#theta_vs_theta_132 = ROOT.TH2D("theta_vs_theta_132","theta_vs_theta_132",80,-1,1,80,-1,1)
#theta_vs_theta_142 = ROOT.TH2D("theta_vs_theta_142","theta_vs_theta_142",80,-1,1,80,-1,1)
#theta_vs_theta_212 = ROOT.TH2D("theta_vs_theta_212","theta_vs_theta_212",80,-1,1,80,-1,1)
#theta_vs_theta_213 = ROOT.TH2D("theta_vs_theta_213","theta_vs_theta_213",80,-1,1,80,-1,1)
#theta_vs_theta_222 = ROOT.TH2D("theta_vs_theta_222","theta_vs_theta_222",80,-1,1,80,-1,1)
#theta_vs_theta_232 = ROOT.TH2D("theta_vs_theta_232","theta_vs_theta_232",80,-1,1,80,-1,1)
#theta_vs_theta_242 = ROOT.TH2D("theta_vs_theta_242","theta_vs_theta_242",80,-1,1,80,-1,1)
#theta_vs_theta_221 = ROOT.TH2D("theta_vs_theta_221","theta_vs_theta_221",80,-1,1,80,-1,1)
#theta_vs_theta_121 = ROOT.TH2D("theta_vs_theta_121","theta_vs_theta_121",80,-1,1,80,-1,1)
#theta_vs_theta_131 = ROOT.TH2D("theta_vs_theta_131","theta_vs_theta_131",80,-1,1,80,-1,1)
#theta_vs_theta_141 = ROOT.TH2D("theta_vs_theta_141","theta_vs_theta_141",80,-1,1,80,-1,1)
#theta_vs_theta_231 = ROOT.TH2D("theta_vs_theta_231","theta_vs_theta_231",80,-1,1,80,-1,1)
#theta_vs_theta_241 = ROOT.TH2D("theta_vs_theta_241","theta_vs_theta_241",80,-1,1,80,-1,1)
	...
	#find the matched CSC Segments on this muon
	    cscMatchedSegments = matchedCSCStubs(g,segmentsCSC,geantCSC)
  	    ...
  	    for s in cscMatchedSegments:
  	        ...
  	        if (ec,station,ring) in dict_of_hist:
                    ...
                    #print (ec,station,ring)
                    #print 'tan_theta_calib: ',tan_theta_calib
                    #print 'tan_theta_tracker: ',tan_theta_tracker
                    #print 'tantheta_diff: ',tantheta_diff
                    #print 'res: ',res
                    #print 'tantheta_diff_res: ',tantheta_diff_res
  	            #if ec == 1:
  	            #    theta_vs_theta_ec1.Fill(tan_theta_calib,tan_theta_tracker)
  	            #elif ec == 2:
  	            #    theta_vs_theta_ec2.Fill(tan_theta_calib,tan_theta_tracker)

                    #if (ec,station,ring)==(2,2,2):
                    #    theta_diff_222.Fill(k,(tan_theta_calib-tan_theta_tracker))
                    #elif (ec,station,ring)==(1,3,2):
                    #    theta_diff_132.Fill(k,(tan_theta_calib-tan_theta_tracker))
...
#theta_diff_222.Write()
#theta_diff_132.Write()
g.Close()
