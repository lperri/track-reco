...
phiOffset_1_1_3 = ROOT.TH2D("offset_1_1_3","Offset_1_1_3; Curvature; Difference in Phi",100,-0.4,0.4,100,-1,1)
phiOffset_1_1_2 = ROOT.TH2D("offset_1_1_2","Offset_1_1_2; Curvature; Difference in Phi",100,-0.4,0.4,100,-1,1)
phiOffset_1_2_2 = ROOT.TH2D("offset_1_2_2","Offset_1_2_2; Curvature; Difference in Phi",100,-0.4,0.4,100,-1,1)
phiOffset_1_3_2 = ROOT.TH2D("offset_1_3_2","Offset_1_3_2; Curvature; Difference in Phi",100,-0.4,0.4,100,-1,1)
phiOffset_1_4_2 = ROOT.TH2D("offset_1_4_2","Offset_1_4_2; Curvature; Difference in Phi",100,-0.4,0.4,100,-1,1)
phiOffset_2_1_3 = ROOT.TH2D("offset_2_1_3","Offset_2_1_3; Curvature; Difference in Phi",100,-0.4,0.4,100,-1,1)
phiOffset_2_1_2 = ROOT.TH2D("offset_2_1_2","Offset_2_1_2; Curvature; Difference in Phi",100,-0.4,0.4,100,-1,1)
phiOffset_2_2_2 = ROOT.TH2D("offset_2_2_2","Offset_2_2_2; Curvature; Difference in Phi",100,-0.4,0.4,100,-1,1)
phiOffset_2_3_2 = ROOT.TH2D("offset_2_3_2","Offset_2_3_2; Curvature; Difference in Phi",100,-0.4,0.4,100,-1,1)
phiOffset_2_4_2 = ROOT.TH2D("offset_2_4_2","Offset_2_4_2; Curvature; Difference in Phi",100,-0.4,0.4,100,-1,1)
...
N=0
#make phiOffsetograms for each (encap,station,ring) to find individual offsets
            ...
            for s in cscMatchedSegments:
                ...
                if phi:
                    if [s.first.endcap(),s.first.station(),s.first.ring()] == [1,1,3]:
                    	phiOffset_1_1_3.Fill((g.charge()/g.pt()),phi-phitrack)
                    elif [s.first.endcap(),s.first.station(),s.first.ring()] == [1,1,2]:
                    	phiOffset_1_1_2.Fill((g.charge()/g.pt()),phi-phitrack)
                    elif [s.first.endcap(),s.first.station(),s.first.ring()] == [1,2,2]:
                    	phiOffset_1_2_2.Fill((g.charge()/g.pt()),phi-phitrack)
                    elif [s.first.endcap(),s.first.station(),s.first.ring()] == [1,3,2]:
                    	phiOffset_1_3_2.Fill((g.charge()/g.pt()),phi-phitrack)
                    elif [s.first.endcap(),s.first.station(),s.first.ring()] == [1,4,2]:
                    	phiOffset_1_4_2.Fill((g.charge()/g.pt()),phi-phitrack)
                    elif [s.first.endcap(),s.first.station(),s.first.ring()] == [2,1,3]:
                    	phiOffset_2_1_3.Fill((g.charge()/g.pt()),phi-phitrack)
                    elif [s.first.endcap(),s.first.station(),s.first.ring()] == [2,1,2]:
                    	phiOffset_2_1_2.Fill((g.charge()/g.pt()),phi-phitrack)
                    elif [s.first.endcap(),s.first.station(),s.first.ring()] == [2,2,2]:
                    	phiOffset_2_2_2.Fill((g.charge()/g.pt()),phi-phitrack)
                    elif [s.first.endcap(),s.first.station(),s.first.ring()] == [2,3,2]:
                    	phiOffset_2_3_2.Fill((g.charge()/g.pt()),phi-phitrack)
                    elif [s.first.endcap(),s.first.station(),s.first.ring()] == [2,4,2]:
                    	phiOffset_2_4_2.Fill((g.charge()/g.pt()),phi-phitrack)
...
f.cd()
phiOffset_1_1_3.Write()
phiOffset_1_1_2.Write()
phiOffset_1_2_2.Write()
phiOffset_1_3_2.Write()
phiOffset_1_4_2.Write()
phiOffset_2_1_3.Write()
phiOffset_2_1_2.Write()
phiOffset_2_2_2.Write()
phiOffset_2_3_2.Write()
phiOffset_2_4_2.Write()
f.Close()
