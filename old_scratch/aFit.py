...
a_222_213 = ROOT.TH2D("a_222_213","($\Delta\Phi$-c$\Phi_{b}$) vs. Curvature; $\Kappa$; ($\Delta\Phi$-c$\Phi_{b}$)",100,-0.3,0.3,100,-0.2,0.2)
	...
	#find the matched CSC Segments on this muon
	    ...
	    for s in cscMatchedSegments:
			...
			#	a_232_212.Fill(k,deltaphi-c*bend2)
				...
				print 'c: ',c
				print 'bend: ',bend2
				print 'deltaphi-c*bend: ',deltaphi-c*bend2
				import pdb;pdb.set_trace()
				a_222_213.Fill(k,deltaphi-c*bend2)
				a_222_213_x.append(k)
				a_222_213_y.append(deltaphi-c*bend2)
