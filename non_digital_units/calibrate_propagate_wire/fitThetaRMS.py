...
''' example of how to run this: python fitThetaRMS.py [ROOT FILE] > [TXT FILE] '''
...
for name,obj in getAll(f):
    ...
    fit_func = ROOT.TF1('fit_func','sqrt(pow([0],2) + pow([1],2)*pow(x,2))',obj.GetXaxis().GetXmin(),obj.GetXaxis().GetXmax())
